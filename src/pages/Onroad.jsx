  ...
  return (
    <main className="min-h-screen bg-white text-gray-800 dark:bg-black dark:text-white pt-[112.38px] transition-colors duration-300">
      ...
      <section className="w-full sm:max-w-[93vw] max-w-[100vw] mx-auto px-4 sm:px-6 lg:px-16 py-12">
        <p className="max-w-full lg:max-w-[93vw] font-rethink font-medium text-xl sm:text-[1.88vw] leading-snug tracking-[-0.02em] text-[#686868] dark:text-[#f2f2f2]">
          ...
          {onroadVideos.map((card) => (
            <div key={card.id} className="flex flex-col">
              ...
              <div className="mt-4 max-w-[519px]">
                ...
                <p className="mt-3 font-rethink font-normal text-[14px] leading- tracking-[-0.02em] text-[#737373] dark:text-[#A3A3A3]">
                  {card.description}
                </p>
